  ...
  public static class ConfigureServices
  {
    ...
    private static IServiceCollection RegisterAuthorization( this IServiceCollection services )
    {
      services.AddAuthorization( options =>
      {
        ...
        options.AddPolicy( AuthorizationConstants.Claim_Policy_IsAdmin, policy =>
          policy.RequireClaim( AuthorizationConstants.Claim_AccessLevel_Type, AuthorizationConstants.Claim_AccessLevel_Admin ) );
